...
export class HardenedAiSdkProviderTransport {
   ...
   *   supportsImages?: ConstructorParameters<typeof AiSdkAgentGateway>[0]["supportsImages"],
   *   readProjectFile: ConstructorParameters<typeof AiSdkAgentGateway>[0]["readProjectFile"],
   *   readProjectComments?: ConstructorParameters<typeof AiSdkAgentGateway>[0]["readProjectComments"],
   *   readProjectFigure?: ConstructorParameters<typeof AiSdkAgentGateway>[0]["readProjectFigure"],
